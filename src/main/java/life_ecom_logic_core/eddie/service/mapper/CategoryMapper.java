...
public final class CategoryMapper {
    ...
    public static CategoryEntity toEntity(CategoryCreate src) {
        ...
        e.setTransactionType(life_ecom_logic_core.eddie.domain.TransactionTypeEnum.valueOf(src.getTransactionType().name()));
        return e;
    }
    ...
    public static void updateEntity(CategoryUpdate e, CategoryEntity src) {
        ...
        if (src.getTransactionType() != null) e.setTransactionType(TransactionType.valueOf(src.getTransactionType().name()));
    }
