...
public class TransactionEntity {
    ...
    /** ID of the original transaction that originated this recurring copy. Stored as raw FK to avoid circular JPA fetch. */
    @Column(name = "parent_transaction_id")
    private Long parentTransactionId;

    /** True when this transaction was generated by a recurring rule. Maps to is_recurring column. */
    @Column(name = "is_recurring", nullable = false)
    private boolean recurring;

    /** True when the amount is an estimate, not yet confirmed. Maps to estimated_amount column. */
